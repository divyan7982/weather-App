    ...
    <div className="weatherData">
      <div className="currtemp">
        <div className="tempAndLogo">
          <div>
            <img
              src="https://img.freepik.com/premium-vector/weather-cloud-sun-rain-lightning-logo-design-symbol-icon-template_23729-1768.jpg?size=626&ext=jpg&uid=R113265601&ga=GA1.2.1777705238.1692000123&semt=ais"
              width={200}
              alt="icon"
            />
          </div>
      ...
      <p className="copyright">&copy;Divyanshu 2023</p>
